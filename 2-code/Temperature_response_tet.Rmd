...
```{r check gompertz model, warning=F, message=F, include = T, eval = F}
...
```{r gompertz model difficult fitting pop, warning=F, message=F, fig.height = 5, fig.width=12.5}
...
```{r check gompertz model difficult fittings, warning=F, message=F, eval = F, include = T}
...
```{r tidy growth data, warning=F, message = F}
...
```{r response data, warning=F, fig.height = 10, fig.width=12.5}
...
```{r MCMC control 38°C,  warning = F, message = F, eval = F, fig.height = 4, fig.width = 5, fig.align="center", include = T}
...
```{r MCMC control 20°C,  warning = F, eval = F, fig.height = 4, fig.width = 5, fig.align="center", include = T}
# store MCMC results in a separate object
